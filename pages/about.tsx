    ...
    <>
      ...
      <Layout>
        <Column>
          ...
          patience of those who taught me and I feel as if it&apos;s only right to pass it on. Currently I&apos;m an Adjunct Lecturer at CUNY teaching OS II and Programming II. 
          Previously throughout college I was a TA for the intro progamming course and later the upper division OS course. Post-grad I volunteer occasionally to TA for
          Stanford&apos;s Code In Place program. In general I love learning (and teaching) and I use code as my medium to express my creativity.
          </p>
          <p style={{marginBottom:"1.5rem"}}>
